...
namespace T3
{
    ...
    public partial class TextBoxCustomH28 : UserControl
    {
        ...
        private void UpdateControlHeight()
        {
            if (textBox1.Multiline == false)
            {
                ...
                //if (this.Height >= 40)
                //    this.Height = 40;
                //else if (this.Height <= 28) this.Height = 28;
                //textBox1.Location = new Point(5, 11 - ((42 - this.Height) / 2));
            }
        }
        #endregion
        #region -> Properties

...
{
    public partial class RowDUTRUN : UserControl
    {
        ...
        public void LoadData(int no, string name, string title, string value, string unit, string min, string max, string type, string typeInput, bool required, bool report)
        {
            _minValue = min;
            _maxValue = max;
            _inputType = type;
            ...
            lblName.Text = (!string.IsNullOrEmpty(title) && title != "N/A") ? title : name;
            lblTitle.Text = title;
            lblUnit.Text = unit;
            txtValue.Text = value;
            ...
            string cleanMin = min?.Trim() ?? "";
            string cleanMax = max?.Trim() ?? "";
        ...
        public bool ValidateInput(out string errorMessage)
        {
            ...
            {
                return ValidateValue(lblTitle.Text, txtValue.Text, _minValue, _maxValue, _inputType, out errorMessage);
            }

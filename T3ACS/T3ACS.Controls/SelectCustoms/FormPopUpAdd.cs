...
namespace T3ACS.Controls.SelectCustoms
{
    public partial class FormPopUpAdd : Form
    {
        string _textFirst;
        string _textAdd;
        public FormPopUpAdd(string text, string textAdd )
        {
            InitializeComponent();
        ...
        public void SetData(List<string> duts)
        {
            _Data = duts;
            ShowWithData(duts);
        }
        ...
        {
            if (sender != null && sender is ItemSelect item)
            {
        ...
        private void FormPopUpAdd_Shown(object sender, EventArgs e)
        {

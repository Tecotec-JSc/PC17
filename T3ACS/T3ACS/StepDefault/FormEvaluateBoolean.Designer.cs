...
namespace T3ACS
{
    partial class FormEvaluateBoolean
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormEvaluateBoolean));
            rtbNote = new RJEditor();
            panelBoolean = new FlowLayoutPanel();
            ...
            // panelBoolean
            // 
            panelBoolean.AutoSizeMode = AutoSizeMode.GrowAndShrink;
            panelBoolean.FlowDirection = FlowDirection.TopDown;
            panelBoolean.Location = new Point(32, 171);
            panelBoolean.Name = "panelBoolean";
            panelBoolean.Size = new Size(1081, 551);
            panelBoolean.TabIndex = 2;
            // 
            // panelControlAll1
            // 
            ...
            panelForm.Controls.Add(panelBoolean);
            ...
            Name = "FormEvaluateBoolean";
            Text = "FormEvaluateBoolean";
        ...
        private FlowLayoutPanel panelBoolean;

...
namespace T3ACS
{
    public partial class FormAddBooleanInputValue : Form
    {
        public FormAddBooleanInputValue()
        {
            InitializeComponent();
        }
        List<string> _values;
        ...
        public void EditPara(string name, string title, string value)
        {
            ...
            if (value.ToUpper() == "TRUE") valueCheck = true;
            chkValue.SetValue(valueCheck, "", "");
            txtTitle.Text = title;       
            lblHugeTitle.Text
                = "Edit Boolean Input";
        }
        ...
        {
            string value1= "";
            if (chkValue._Checked) value1 = "True";
            else value1 = "False";
            return new List<string>() { txtName.Text, value1, txtTitle.Text };
        }

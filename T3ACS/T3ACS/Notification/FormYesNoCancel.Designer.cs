...
namespace T3ACS
{
    partial class FormYesNoCancel
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnNo.BackColors = Color.White;
            btnNo.BorderColor = Color.FromArgb(227, 242, 253);
            btnNo.BorderFocusColor = Color.FromArgb(3, 120, 212);
            btnNo.BorderRadius = 5;
            btnNo.BorderSize = 1;
            btnNo.Font = new Font("Segoe UI Variable Text Semibold", 10.5F, FontStyle.Bold, GraphicsUnit.Point, 0);
            btnNo.ForeColors = Color.FromArgb(0, 32, 77);
            btnNo.HoverColors = Color.DarkGray;
            btnNo.Location = new Point(166, 122);
            btnNo.Name = "btnNo";
            btnNo.Size = new Size(135, 36);
            btnNo.TabIndex = 10;
            btnNo.Texts = "lblbtn1";

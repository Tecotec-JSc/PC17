...
namespace T3ACS
{
    public partial class FormYesNoCancel : Form
    {
        public FormYesNoCancel()
        {
            ...
            btnNo.BorderColor = Color.FromArgb(204, 215, 230);
            btnNo.BorderFocusColor = Color.FromArgb(0, 82, 130);
        ...
        public void LoadData(string title, string content, string strBtnOk, string strbtnNo, string strbtnCancel, int type)
        {
            lblTitle.Text = title;
            lblContent.Text = content;
            btnNo.Texts = strbtnNo;
